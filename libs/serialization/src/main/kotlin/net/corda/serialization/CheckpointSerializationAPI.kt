...
interface CheckpointSerializationContext {
    ...
    /**
     * The list of Bundles to use for deserialization.
     */
    ...
    /**
     * Helper method to return a new context with the list of Bundles used for deserialization changed.
     */
    fun withBundles(bundles: List<Bundle>): CheckpointSerializationContext
