...
import net.corda.configuration.write.WrongVersionException
import net.corda.data.config.ConfigurationManagementRequest
import net.corda.db.connection.manager.DbConnectionManager
import net.corda.db.core.DbPrivilege.DML
import net.corda.db.schema.CordaDb.CordaCluster
...
internal class ConfigEntityWriter(private val dbConnectionManager: DbConnectionManager) {
    ...
    fun writeEntities(req: ConfigurationManagementRequest, clock: Clock): ConfigEntity {
        ...
        val entityManagerFactory = dbConnectionManager.getOrCreateEntityManagerFactory(CordaCluster, DML)
