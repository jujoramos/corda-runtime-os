...
class PersistenceServiceInternalTests {
    ...
    fun `merge in db`() {
        ...
        val bytes = entityResponseSuccess.result as List<ByteBuffer>
    ...
    private fun assertQuery(
        ...
        if (expectFailure != null) {
            ...
            return (response.responseType as EntityResponseSuccess).result.map { ctx.deserialize(it as ByteBuffer) }
        }
    }
